...
namespace PushPopActor.ApiServer.Services;

/// <summary>
/// gRPC service implementation for PushPopQueue operations.
/// Mirrors the HTTP REST API functionality but uses Protocol Buffers and gRPC status codes.
/// </summary>
public class PushPopQueueGrpcService : PushPopQueue.PushPopQueueBase
{
    private readonly ILogger<PushPopQueueGrpcService> _logger;
    private readonly ActorConfiguration _actorConfig;
    private readonly IActorInvoker _actorInvoker;

    public PushPopQueueGrpcService(
        ILogger<PushPopQueueGrpcService> logger,
