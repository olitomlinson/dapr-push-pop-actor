...
using ActorModels = PushPopActor.Interfaces;
using Xunit;

namespace PushPopActor.Tests;

/// <summary>
/// Unit tests for PushPopQueueGrpcService to verify gRPC status code mappings
/// and response transformations from actor responses to gRPC messages.
/// </summary>
public class PushPopQueueGrpcServiceTests
{
    private readonly Mock<ILogger<PushPopQueueGrpcService>> _mockLogger;
    private readonly ActorConfiguration _actorConfig;
    private readonly Mock<ServerCallContext> _mockContext;

    public PushPopQueueGrpcServiceTests()
    {
        _mockLogger = new Mock<ILogger<PushPopQueueGrpcService>>();
    ...
    public async Task Push_ValidRequest_ReturnsSuccess()
    {
        ...
        var service = new PushPopQueueGrpcService(_mockLogger.Object, _actorConfig, mockInvoker.Object);
